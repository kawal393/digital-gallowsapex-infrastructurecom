    ...
    <div className="container mx-auto max-w-4xl">
      <div className="rounded-2xl border border-primary/30 bg-gradient-to-r from-primary/10 via-card to-primary/5 p-8 md:p-12 text-center">
        ...
        <h2 className="text-2xl md:text-3xl font-bold mb-3">
          Earn <span className="text-gold-gradient">50%</span> on Every Sale
        </h2>
        <p className="text-muted-foreground mb-6 max-w-md mx-auto">
          Join our partner program and earn half of every sale you refer. No cap, no limits, no strings.
        </p>
