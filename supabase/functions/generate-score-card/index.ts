...
Deno.serve(async (req) => {
  ...
  <!-- CTA -->
  <text x="600" y="580" text-anchor="middle" fill="#d4a017" font-size="14" font-family="system-ui" opacity="0.7">Check your compliance score → apex-psi.apex-infrastructure.com/assess</text>
